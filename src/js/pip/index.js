...
export class PiPManager {
  ...
  renderAll(pipEnabled, lastOBB, paddingWidthScale, paddingHeightScale, paddingDepthTopScale, paddingDepthBottomScale, fieldFlowCanvases, rotationAngle = null, showPiP4 = true, velocity = null, normalForce = 1.0, intensityScale = 1.0) {
    ...
    if (showPiP4) {
      ...
      this.pip4.updateStencil(intersectionData, velocity, normalForce, intensityScale);
      this.pip4.render();
    } else {
      this.pip4.clear();
    }
